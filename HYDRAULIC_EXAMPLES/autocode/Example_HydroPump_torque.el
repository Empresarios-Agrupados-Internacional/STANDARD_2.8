...
COMPONENT Example_HydroPump_torque 
...
TOPOLOGY
   ...
   HYDRAULIC.HydPipe penstock(
         z_in = 5,  -- Non default value.
         z_out = 80,  -- Non default value.
   ...
   HYDRAULIC.HydPump(
         ...
         eta_mech = 0.95,
         I = 0.1)
   MECHANICAL.R_ActuatorTorque Engine
   ...
   CONNECT Fluid.hp_out TO Lower_Reservoir.hp_in

   CONNECT penstock.hp_out TO Upper_Reservoir.hp_in

   CONNECT Lower_Reservoir.hp_out TO Pump.hp_in

   CONNECT Pump.hp_out TO penstock.hp_in

   CONNECT Engine.m_out TO SensorVelocity_rpm.m_in

   CONNECT Pump.sh TO SensorVelocity_rpm.m_in

   CONNECT Cntrl_PI.s_out TO Engine.s_in

   CONNECT SensorVelocity_rpm.s_out TO Cntrl_PI.s_var

   CONNECT rpm_set.s_out TO Cntrl_PI.s_set

   CONNECT Upper_Reservoir.hp_out TO Outlet.f_in
