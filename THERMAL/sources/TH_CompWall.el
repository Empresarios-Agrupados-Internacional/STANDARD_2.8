...
COMPONENT Wall
	...
	DECLS
		...
		EXPL REAL k_var[nodes+2]		UNITS u_W_mK		"Thermal conductivities of the nodes"
		EXPL REAL k_eq[nodes+1]		UNITS u_W_mK		"Equivalent Thermal Condictivities between nodes"
