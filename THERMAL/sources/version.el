...
#LIBRARY_INFO
  ...
  #COMMENTS= "Adding new components for free convection calculation. Detaching dependence of FLUID_PROP\
      ...
      version 4.0.6: :\
                     a/ Added new component GL_Vec\
                     b/ Modified Radiator with mass calculation, possibility of having a number of identical radiators, and a bug fix when n_fin == 2\
                     c/ new thermoProp enum for cp,rho and K\
                     d/  Added new property files of materials (see TH_material_prop_ref.el file)\
      version 4.0.7: :\
                     a/ Added new materials LiH and ZrCp\
      version 4.0.8:\
                     a/ Added new component DNode_vec\
                     b/ Updated symbols of mux/demux components\
                     c/ Added new component DNodenTom\
                     d/ Added new component Th_InvIndex\
							e/ Modified the Wall component. The variables k_var and k_eq are forced to explicit\
      "
END #LIBRARY_INFO
